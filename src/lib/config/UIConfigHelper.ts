...
import CommonSettingsLoader from "./CommonSettingsLoader";
import { getVolumioBackgrounds } from "../utils/Misc";
import myBackgroundMonitor from "../utils/MyBackgroundMonitor";
import np, { type I18nKey } from "../NowPlayingContext";
import ConfigHelper from "./ConfigHelper";
import FontHelper from "../utils/FontHelper";
import * as KioskUtils from '../utils/Kiosk';
import ConfigBackupHelper from "./ConfigBackupHelper";
...
export default class UIConfigHelper {
  ...
  static async populate(uiconf: ObservedUIConfig) {
